  ...
  <body>
    ...
    <div class="content-container">
        ...
        <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            ...
            <a href="Admin_LeaveApplication.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black;" class ="AcitonButtons" value="Admin Dashboard"><b>Leave Application</b></a>
        </div>
        ...
        <div style="width:80%;">
          <?php
            ...
            $ID = $_SESSION["uid"];
            $sql = "SELECT * FROM leave_table WHERE Developer_ID = '-1' ORDER BY DateApplied DESC";
            $i = 0;
                  ...
                  while($row=mysqli_fetch_array($result))
                  {
                    ...
                    <tr>
                      ...
                      else
                      {
                        ...
                        href="Admin_ApplicationStatusAcceptReject.php?ID='.$row["LeaveTable_ID"].'&Status=Accepted&Type=Leave">
                        &#10003;</a><a>&nbsp&nbsp&nbsp</a><a style="text-decoration:none;font-size:25px;color:red" 
                        href="Admin_ApplicationStatusAcceptReject.php?ID='.$row["LeaveTable_ID"].'&Status=Rejected&Type=Leave">
                        &#9747;</a></td>';
                      }
