    ...
    <div class="content-container">
      ...
      <div >
        ...
        <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            ...
            <a href="Manager_MyAdvanceApplication.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black"class ="AcitonButtons" value="Update Information"><b>Advance Application</b></a>
            <a href="Manager_ApplicationStatus.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Recieved Complaint">Complaint</a>
