  ...
  <div class="content-container">
    <div class="container-fluid">
        ...
        <div style="margin-top: 3%;padding-bottom: 3%;"class="row">
            <a href="Manager_Dashboard.php" style="height:45px;width:25%;margin-left: 22.5%;background-color:black;color:white;" class ="AcitonButtons" value="Admin Dashboard">Manager Dashboard</a>
            <a href="Manager_SearchDeveloper.php" style="height:45px;width:25%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Update Information">Search Developer</a>
        </div>
                ...
                <table style="margin-top:0px;padding-top: 0px"class="table">
                  ...
                  while($row=mysqli_fetch_array($result))
                  {
                    ...
                    <tr>
                      ...
                      <td>'.$row["Email"].'</td>
                      <td>'.$row["Salary"].'</td>
                      <td><a style="width:90%"class="Search-button" href="Manager_EmployeeDetails.php?ID='.$row["Developer_ID"].'&Type=Developer">Details</a></td>
                    </tr>';
