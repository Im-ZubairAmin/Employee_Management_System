    ...
    <div class="content-container">
      ...
      <div >
        ...
        <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            ...
            <a href="Manager_MyLeaveApplication.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black" class ="AcitonButtons" value="Admin Dashboard"><b>Leave Application</b></a>
        </div>
