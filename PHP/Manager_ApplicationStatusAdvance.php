  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Manager_ApplicationStatusLeave.php">
    ...
    <div class="content-container">
      ...
      <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            <a href="Manager_ApplicationStatusLoan.php" style="height:45px;width:15%;margin-left: 7.5%;background-color: black;color:white;" class ="AcitonButtons" value="Admin Dashboard">Loan Application</a>
            <a href="Manager_ApplicationStatusAdvance.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black"class ="AcitonButtons" value="Update Information"><b>Advance Application</b></a>
            <a href="Manager_ApplicationStatusComplaint.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Recieved Complaint">Recieved Complaint</a>
            <a href="Manager_ApplicationStatusLeave.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;" class ="AcitonButtons" value="Admin Dashboard">Leave Application</a>
        </div>
        ...
        <div style="width:80%;">
          <?php
            ...
            $ID = $_SESSION["uid"];
            $sql = "SELECT * FROM advance_table WHERE Manager_ID ='$ID' and Developer_ID != '-1' ORDER BY DateApplied DESC";
            $i = 0;
                ...
                <table style="margin-top:0px;padding-top: 0px"class="table">
                  ...
                  while($row=mysqli_fetch_array($result))
                  {
                    ...
                    <tr>
                      ...
                      {
                        echo'<td><a style="text-decoration:none;font-size:25px;color:green"
                        href="Manager_ApplicationStatusAcceptReject.php?ID='.$row["AdvanceTable_ID"].'&Status=Accepted&Type=Advance">
                        &#10003;</a><a>&nbsp&nbsp&nbsp</a><a style="text-decoration:none;font-size:25px;color:red" 
                        href="Manager_ApplicationStatusAcceptReject.php?ID='.$row["AdvanceTable_ID"].'&Status=Rejected&Type=Advance">
                        &#9747;</a></td>';
                      }
