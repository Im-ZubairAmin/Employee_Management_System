  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Manager_Complaint.php">
    ...
    <div class="content-container">
      ...
      <div style="width:90%;margin-left: 5%;margin-top: 1%;float:left;"class="jumbotron">
        ...
        <form style="width:90%;margin-left: 5%;margin-top: 3%;"action="Manager_PHPComplaint.php">
            <?php 
