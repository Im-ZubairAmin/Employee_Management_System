  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="content-container">
      ...
      <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            <a href="Manager_ApplicationStatusLoan.php" style="height:45px;width:15%;margin-left: 7.5%;background-color: white;color:black;border:1px solid black" class ="AcitonButtons" value="Admin Dashboard"><b>Loan Application</b></a>
            <a href="Manager_ApplicationStatusAdvance.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Update Information">Advance Application</a>
        ...
        <div style="width:80%;">
          <?php
            ...
            $ID = $_SESSION["uid"];
            $sql = "SELECT * FROM loan_table WHERE Manager_ID ='$ID'  and Developer_ID != '-1' ORDER BY DateApplied DESC";
            $i = 0;
                  ...
                  while($row=mysqli_fetch_array($result))
                  {
                    ...
                    <tr>
                      ...
                      else
                      {
                        ...
                        href="Manager_ApplicationStatusAcceptReject.php?ID='.$row["LoanTable_ID"].'&Status=Accepted&Type=Loan">
                        &#10003;</a><a>&nbsp&nbsp&nbsp</a><a style="text-decoration:none;font-size:25px;color:red" 
                        href="Manager_ApplicationStatusAcceptReject.php?ID='.$row["LoanTable_ID"].'&Status=Rejected&Type=Loan">
                        &#9747;</a></td>';
                      }
