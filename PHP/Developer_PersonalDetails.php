      ...
      <?php
        ...
        if($EmployeeType == "Developer")
        {
          ...
          <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            <a href="Developer_Dashboard.php" style="height:45px;width:25%;margin-left: 25%;color:white;" class ="AcitonButtons" value="Admin Dashboard">Developer Dashboard</a>
            <a href="Developer_UpdatePersonalDetails.php" style="height:45px;width:25%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Update Information">Update Information</a>
          </div>
