  ...
  <body>
    ...
    <div class="content-container">
        ...
        <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            ...
            <a href="Admin_AdvanceApplication.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black;"class ="AcitonButtons" value="Update Information"><b>Advance Application</b></a>
            <a href="Admin_Complaint.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Update Information">Complaint History</a>
        ...
        <div style="width:80%;">
          <?php
            ...
            $ID = $_SESSION["uid"];
            $sql = "SELECT * FROM advance_table WHERE  Developer_ID = '-1' ORDER BY DateApplied DESC";
            $i = 0;
                  ...
                  while($row=mysqli_fetch_array($result))
                  {
                    ...
                    <tr>
                      ...
                      else
                      {
                        ...
                        href="Admin_ApplicationStatusAcceptReject.php?ID='.$row["AdvanceTable_ID"].'&Status=Accepted&Type=Advance">
                        &#10003;</a><a>&nbsp&nbsp&nbsp</a><a style="text-decoration:none;font-size:25px;color:red" 
                        href="Admin_ApplicationStatusAcceptReject.php?ID='.$row["AdvanceTable_ID"].'&Status=Rejected&Type=Advance">
                        &#9747;</a></td>';
                      }
