  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Manager_ApplicationStatus.php">
    ...
    <div class="content-container">
      ...
      <div >
        ...
        <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            <a href="Manager_MyLoanApplication.php" style="height:45px;width:15%;margin-left: 7.5%;background-color: black;color:white;" class ="AcitonButtons" value="Admin Dashboard">Loan Application</a>
            <a href="Manager_MyAdvanceApplication.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="Update Information">Advance Application</a>
            <a href="Manager_ApplicationStatus.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black"class ="AcitonButtons" value="Recieved Complaint"><b>Complaint</b></a>
            <a href="Manager_MyLeaveApplication.php" style="height:45px;width:15%;margin-left: 5%;background-color: black;color:white;" class ="AcitonButtons" value="Admin Dashboard">Leave Application</a>
        </div>
        ...
        <div style="width:80%;">
          <?php
            ...
            $ID = $_SESSION["uid"];
            $sql = "SELECT * FROM complaint_table WHERE Manager_ID ='$ID' and Developer_ID='-1'";
            $i = 0;
