  ...
  <body>
    ...
    <div style="position:fixed;" class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Admin_ProjectDetails.php">
            ...
            <div style="width:90%;margin-left: 5%;margin-top: 1%;float:left;"class="jumbotron" >
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
                      <th style="text-align: center;border-bottom: 1px solid white;">Update Project Status to Completed</th>
                    </tr>
                  </thead>
                </table>
            </div>

              <form style="width:90%;margin-left: 5%;margin-top: 10%;"action="Admin_PHPProjectDescription.php" method='post'>
                ...
                <div style="font-size: 18;"class="row">
                    ...
                    <div style="width: 20%">
                        <select  value="Project" id="Project" name="Project">';
                          <?php
                            ...
                            $sql="SELECT * FROM project_info WHERE Status='Pending' or Status='Assigned'";
                    ...
                    <div style="margin-top: 4%;"class="row">
                        <input style="height:45px"type="submit" value="Update">
                    </div>
                </form>
                          
        
        <div style="width:100%;margin-left: 0%;margin-top: 5%;float:left;"class="jumbotron" >
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
