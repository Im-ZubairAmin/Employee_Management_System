  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Developer_LeaveApplication.php">
    ...
    <div class="content-container">
      ...
      ?>
        ...
        <form style="width:90%;margin-left: 5%;margin-top: 3%;"action="Developer_PHPLeaveApplication.php">
            <?php 
