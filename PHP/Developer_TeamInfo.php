  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
            <a style="text-decoration: none;background-color: white;color: black;" href="Developer_TeamInfo.php">
      ...
      ?>
        ...
        <div style="width:90%;margin-left: 5%;margin-top: 1%;float:left;"class="jumbotron">
          <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
            <thead class="table-dark">
              <tr >
                <th style="text-align: center;border-bottom: 1px solid white;">Team & Project Info</th>
              </tr>
            </thead>
          </table>
        </div>
        ...
        <?php
            ...
            if($Team != 0)
            {
              ...
              $sql = "SELECT * FROM teams_info where Team_ID='$Team'";
              $run_query = mysqli_query($con,$sql);
              $num1 = mysqli_num_rows($run_query);
              if($num1 > 0)
              {
                ...
                if($Project != 0)
                {
                    $sql = "SELECT * FROM project_info where Project_ID='$Project'";
                    $run_query1 = mysqli_query($con,$sql);
                    $num2 = mysqli_num_rows($run_query1);

                    if($num2 > 0)
                    {
                    $row2 = mysqli_fetch_array($run_query1);
                  
                    $ProjectName = $row2['ProjectName'];
                    
                    $ST = $row2['SoftwareType'];
                    $StartDate = $row2['StartDate'];
                    $EndDate = $row2['EndDate'];
                    
                    echo'
                    <div style="width:90%;margin-left: 5%;float:left"class="jumbotron">
            ...
            else
            {
              ...
              echo'
                    ...
                    <table style="margin-top:0px;padding-top: 0px"class="table">
                        ...
                        <tbody>
                            <tr>
                                <td>Not Assigned to any team</td>
