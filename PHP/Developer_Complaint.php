  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
            <a style="text-decoration: none;background-color: white;color: black;" href="Developer_Complaint.php">
        ...
        <div style="width:90%;margin-left: 5%;margin-top: 1%;float:left;"class="jumbotron">
          <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
            <thead class="table-dark">
              <tr >
                <th style="text-align: center;border-bottom: 1px solid white;">Complaint</th>
              </tr>
            </thead>
          </table>
        </div>

        <form style="width:90%;margin-left: 5%;margin-top: 3%;"action="Developer_PHPComplaint.php">
            <?php 
            ...
            <div style="font-size: 18;"class="row">
                ...
                <div style="width:86%;margin-top: 1%;">
                    <textarea name="Complaint" style="border-color: black;height:200px" placeholder="Complaint (100 to 500 words)"></textarea>
                </div>
            ...
            <div style="font-size: 18;"class="row">
                ...
                <div style="width:14%;">
                    <label for="ComplaintTo">Complaint To</label>
                </div>
                <div style="width: 20%">
                    <select  id="ComplaintTo" name="ComplaintTo">
