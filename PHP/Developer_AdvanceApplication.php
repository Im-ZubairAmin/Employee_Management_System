  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Developer_AdvanceApplication.php">
    ...
    <div class="content-container">
      ...
      ?>
        ...
        <form style="width:90%;margin-left: 5%;margin-top: 3%;"action="Developer_PHPAdvanceApplication.php">
          <?php
            ...
            <div style="font-size: 18;"class="row">
                <div style="width:14%;margin-top: 1%;">
                    <label for="Reason">Application</label>
                </div>
            ...
            <div style="font-size: 18;"class="row">
                ...
                <div style="width: 20%">
                    <input style="border-color: black;height:35px" type="text" id="AdvanceAmount" name="AdvanceAmount" placeholder="Advance Amount">
                </div>
