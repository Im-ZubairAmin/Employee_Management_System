  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="content-container">
      ...
      <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            ...
            <a href="Manager_ApplicationStatusComplaint.php" style="height:45px;width:15%;margin-left: 5%;background-color: white;color:black;border:1px solid black;"class ="AcitonButtons" value="Recieved Complaint"><b>Recieved Complaint</b></a>
        ...
        <div style="width:80%;">
          <?php
            ...
            $ID = $_SESSION["uid"];
            $sql = "SELECT * FROM complaint_table WHERE Manager_ID ='$ID' and Developer_ID !='-1' and ComplaintTo='Manager' ORDER BY DateOfComplaint DESC";
            $i = 0;
