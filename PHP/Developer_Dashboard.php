  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Developer_Dashboard.php">
             Dashboard
          </a>
        </li>
        <li>
        ...
        <li>
            <a style="text-decoration: none;" href="Developer_ApplicationStatus.php">
               Application Status
            </a>
        </li>
              ...
              <p>&nbsp&nbsp&nbsp
                <?php
                  ...
                  else
                  {
                    ...
                    $sql = "SELECT * FROM loan_table WHERE Developer_ID ='$ID' and Status = 'Pending' and Active='no'";
                    $result = mysqli_query($con, $sql);
                    $count = mysqli_num_rows($result);
                    $row = mysqli_fetch_array($result);
              ...
              <p>&nbsp&nbsp&nbsp
                <?php
                  ...
                  else
                  {
                    ...
                    $sql = "SELECT * FROM advance_table WHERE Developer_ID ='$ID' and Status = 'Pending' and Active='no'";
                    $result = mysqli_query($con, $sql);
                    $count = mysqli_num_rows($result);
                    $row = mysqli_fetch_array($result);
        ...
        <div style="width:75%;margin-left: 3%;margin-top: 1%;float:left;"class="jumbotron">
          <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
            <thead class="table-dark">
              <tr >
                <th style="text-align: center;border-bottom: 1px solid white;">Developer Information</th>
              </tr>
            </thead>
          </table>
        </div>
            ...
            <tbody>
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql = "SELECT * FROM leave_table WHERE Developer_ID ='$ID'";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
              ...
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql = "SELECT * FROM leave_table WHERE Developer_ID ='$ID' and Status='Accepted'";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
              ...
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql=" SELECT * FROM leave_table WHERE Developer_ID = '$ID' ORDER BY leave_table.DateApplied DESC LIMIT 1";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
              ...
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql = "SELECT * FROM loan_table WHERE Developer_ID ='$ID' and Status='Accepted'";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
              ...
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql=" SELECT * FROM loan_table WHERE Developer_ID = '$ID' ORDER BY loan_table.DateApplied DESC LIMIT 1";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
                  if($count > 0)
              ...
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql = "SELECT * FROM advance_table WHERE Developer_ID ='$ID' and Status='Accepted'";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
              ...
              <tr>
                <?php
                  ...
                  $ID = $_SESSION["uid"];
                  $sql=" SELECT * FROM advance_table WHERE Developer_ID = '$ID' ORDER BY advance_table.DateApplied DESC LIMIT 1";
                  $result = mysqli_query($con, $sql);
                  $count = mysqli_num_rows($result);
                  $row = mysqli_fetch_array($result);
