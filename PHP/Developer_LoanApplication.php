  ...
  <body>
    ...
    <div class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
            <a style="text-decoration: none;background-color: white;color: black;" href="Developer_LoanApplication.php">
    ...
    <div class="content-container">
      ...
      ?>
        ...
        <form style="width:90%;margin-left: 5%;margin-top: 3%;"action="Developer_PHPLoanApplication.php">
        <?php 
            
            if(isset($_SESSION['uid']))
            {
              $userid = $_SESSION["uid"];
              echo'<input type="hidden" name="DeveloperID" value='.$userid.'>'; 

              $sql = "SELECT * FROM developer_info where Developer_ID='$userid'";
            ...
            <div style="font-size: 18;"class="row">
                ...
                <div style="width: 20%">
                    <input style="border-color: black;height:35px" type="text" id="LoanAmount" name="LoanAmount" placeholder="Loan Amount">
                </div>

                <div style="width:16%; margin-left: 5%;">
                    <label for="LeaveDays">Loan Period (Months)</label>
                </div>
                <div style="width: 20%">
