  ...
  <body>
    ...
    <div style="position:fixed;" class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Admin_JobTitle.php">
      ...
      ?>
            <section style="width: 100%;margin: auto;padding: 10px;">
                ...
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
                      <th style="text-align: center;border-bottom: 1px solid white;">Add Job Title</th>
                    </tr>
                  </thead>
                </table>
            </div>
            <br>    
                <form style="width:90%;margin-left: 5%;margin-top: 10%;"action="Admin_PHPAddJobTitle.php" method='post'>
                ...
                <div style="font-size: 18;"class="row">
                    ...
                    <div style="width:40%">
                        <input style="border-color: black;height:35px" type="text" id="AddJobTitle" name="AddJobTitle" placeholder="Job Title">
                    </div>
                    </div>
                
                    <div style="margin-top: 4%;"class="row">
                        <input style="height:45px"type="submit" value="Add Job Title">
                    </div>
                </form>
                </div>
            ...
            while($row=mysqli_fetch_array($result))
            {
              ...
              <tr>
                ...
                <td><a class='DeleteButton' style='height:40px;margin-left: 5%;background-color:red;color:white;' href='Admin_PHPDeleteJobTitle.php?varname=".$row['JobTitle_ID']."'>Delete</a></td>
              </tr>";
              $i++;
            }
