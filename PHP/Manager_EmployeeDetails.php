      ...
      <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
        <ul class="navbar-nav me-auto">
          <li class="nav-item active">
            <a class="nav-link" href="Admin_PersonalDetails.ph">
              <?php 
      ...
      <?php
        ...
        if($EmployeeType == "Developer")
        {
          ...
          <div style="margin-top: 3%;padding-bottom: 5%;"class="row">
            <a href="Manager_Dashboard.php" style="height:45px;width:25%;margin-left: 7.5%;color:white;" class ="AcitonButtons" value="Admin Dashboard">Manager Dashboard</a>
            <a href="Manager_GiveBonus.php?ID='.$ID.'&Type='.$EmployeeType.'" style="height:45px;width:25%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="AssignTeam">Give Bonus</a>
            <a href="Manager_AssignTeam.php?ID='.$ID.'&Type='.$EmployeeType.'" style="height:45px;width:25%;margin-left: 5%;background-color: black;color:white;"class ="AcitonButtons" value="AssignTeam">Assign Team</a>
          </div>';
          }
          else if($row['Bonus'] > 0) 
          {
