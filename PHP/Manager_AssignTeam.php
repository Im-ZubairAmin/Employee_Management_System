    ...
    <div class="container-fluid">
     ...
     <?php
        ...
        if($EmployeeType == "Developer")
        {
            ...
            $TEAMID = "Not Assigned";
            $sql = "SELECT * FROM teams_info WHERE TeamName != '$TEAMID'";
            ...
            <div style="width:90%;margin-left: 5%;margin-top: 1%;float:left;"class="jumbotron" >
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
                      <th style="text-align: center;border-bottom: 1px solid white;">Assign Team</th>
                    </tr>
                  </thead>
                </table>
            </div>
            <br>
            <form style="width:90%;margin-left: 5%;margin-top: 5%;"action="Manager_PHPAssignTeam.php" method="post">
            <div style="font-size: 18;"class="row">
                ...
                <div style="width: 13%">
                    <select  value="Team" id="Team" name="Team">';
                        while($Teams=mysqli_fetch_array($result))
                        {
                            $TID = $Teams['Team_ID'];
                            $TNAME = $Teams['TeamName'];
            ...
            <div style="margin-top: 3%;"class="row">
                <input style="height:45px"type="submit" value="AssignTeam">
            </div>
            </form>
          </div>';
        }
