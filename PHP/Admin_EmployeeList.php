  ...
  <body>
    ...
    <div style="position:fixed;" class="sidebar-container">
      ...
      <ul class="sidebar-navigation">
        ...
        <li>
          <a style="text-decoration: none;background-color: white;color: black;" href="Admin_EmployeeList.php">
    ...
    <div class="content-container">
      ...
      ?>
        ...
        <div style="width:100%;margin-left: 0%;margin-top: 0%;float:left;"class="jumbotron" >
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
                      <th style="text-align: center;border-bottom: 1px solid white;">Current Employees List </th>
                    </tr>
                  </thead>
                </table>
            </div>

            <div style="margin-top:0%;width: 100%;margin-left:0%;float: left;overflow:hidden;overflow-y: scroll;height: 550px; // change this to desired height">
        ...
        <div style="width:100%;margin-left: 0%;margin-top: 3%;float:left;"class="jumbotron" >
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
                      <th style="text-align: center;border-bottom: 1px solid white;">Retired Employees List </th>
                    </tr>
                  </thead>
                </table>
            </div>

            <div style="margin-top:0%;width: 100%;margin-left:0%;float: left;overflow:hidden;overflow-y: scroll;height: 450px; // change this to desired height">
                <table style="margin-top:0px;padding-top: 0px"class="table">
            <thead class="table-dark">
              ...
              <th scope="col">Sr. NO</th>
                ...
                <th scope="col">Email</th>
                <th scope="col">Phone Number</th>
                <th scope="col">Retirment Date</th>
                <th scope="col">Type</th>
            ...
            <?php
            $sql = "SELECT * FROM retired_employees";
            $Space = " ";
            $result = mysqli_query($con, $sql);
            $i = 1;
            ...
            if($num > 0)
            {
              while($row=mysqli_fetch_array($result))
              {
                ...
                <td>".$row['Email']."</td>
                <td>".$row['Phone_Number']."</td>
                <td>".$row['DateOfRetiring']."</td>
                <td>".$row['TypeOfEmployee']."</td>
              </tr>";
              $i++;
              }
            }
            ...
            ?>
                ...
                <table style="margin-bottom: 0px;padding-bottom: 0px;"class="table">
                  <thead class="table-dark">
                    <tr >
                      <th style="text-align: center;border-bottom: 1px solid white;">Fired Employees List </th>
                    </tr>
                  </thead>
                </table>
            </div>
            ...
            <?php
            $sql = "SELECT * FROM fired_employees";
            $Space = " ";
            $result = mysqli_query($con, $sql);
            $i = 1;
            $num = mysqli_num_rows($result);
